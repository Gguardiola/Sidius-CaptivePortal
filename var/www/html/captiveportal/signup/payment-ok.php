...
<html lang="en">
  <head>
    ...
    <meta name="apple-mobile-web-app-title" content="PAYMENT SUCCESSFUL">
          ...
          <div class="demo-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
                ...
                if(isset($_SESSION['validation'])){
                  unset($_SESSION['validation']);
                    ...
                    print('
                        <img style="max-width: 100%;max-height: 100%;" src="images/tickpayment.png"><br>
                        <h2>PAYMENT SUCCESSFUL!</h2><br>
                        <p>Now you can log in and surf the internet!</p>
