...
<html lang="en">
  <head>
    ...
    <meta name="apple-mobile-web-app-title" content="PAYMENT FAILED">
        ...
        <div align=center class="demo-container mdl-grid">
          ...
          <div class="demo-content mdl-color--white mdl-shadow--4dp content mdl-color-text--grey-800 mdl-cell mdl-cell--8-col">
                ...
                if(isset($_SESSION['validation'])){
                    ...
                    print('
                        <img style="max-width: 100%;max-height: 100%;" src="images/crosspayment.png"><br>
                        <h2>PAYMENT FAILED!</h2><br>
                        <p>Something is bad with the payment gateway, please contact with the captive portal administrator:<strong> '.$config['admin_mail'].'</strong></p>
