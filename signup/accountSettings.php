                ...
                elseif($_GET['action'] == "upgrade"){
                    ...
                    //PRINTING THE UPGRADE PLAN PAGE
                        ...
                        <div align=center>
                            ...
                            <div style="margin-left: 1%;-webkit-box-shadow: inset -4px -2px 25px -2px rgba(0,0,0,0.41);-moz-box-shadow: inset -4px -2px 25px -2px rgba(0,0,0,0.41);box-shadow: inset -4px -2px 25px -2px rgba(0,0,0,0.41);width: 317px;height: 490px;overflow-x: scroll;overflow-y:hidden">
